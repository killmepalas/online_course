...
<div id="container">
    <main class="edit">
        <form:form method="POST" modelAttribute="user" action="${contextPath}/updatePassword/${user.id}?${_csrf.parameterName}=${_csrf.token}">
            ...
            <form method="post" action="${contextPath}/updatePassword/${user.id}">
